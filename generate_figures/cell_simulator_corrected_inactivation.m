%% cell_simulator_corrected_inactivation.m
% Matlab class enabling simulations of the host cell - with corrected ODE
% representation of ribosome inactivation by chloramphenicol
...
classdef cell_simulator_corrected_inactivation
    ...
    methods (Access = public)
        % CONSTRUCTOR
        function obj = cell_simulator_corrected_inactivation(tf)
        ...
        function dxdt = ss_model(obj, t, x)
            ...
            dxdt = [
                    ...
                    obj.form.F_r(par,T).*par('c_r').*par('a_r')-(par('b_r')+l).*m_r-kcmh.*(m_r./k_r./D).*R;
                    % ,metabolic protein a
