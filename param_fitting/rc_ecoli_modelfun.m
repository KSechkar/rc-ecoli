%% rc_ecoli_modelfun.m
% retrieves steady-state growth rate and ribosomal mass fraction - for
% parameter fitting using DRAM

%%

function ymodel=rc_ecoli_modelfun(theta,xdata,sim,Delta,Max_iter)
